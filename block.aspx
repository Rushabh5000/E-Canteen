<%@ Page Language="C#" MasterPageFile="logged.master" AutoEventWireup="true" CodeFile="block.aspx.cs" Inherits="block" %>
...
<div class="panel-title"> BLOCK RFID </div>
</div>
...
<div class="col-md-6">
<asp:TextBox runat="server" ID="TextBox2" CssClass="form-control" placeholder="Reason "></asp:TextBox>
