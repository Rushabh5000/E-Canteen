<%@ Page Language="C#" MasterPageFile="logged.master" AutoEventWireup="true" CodeFile="reissue.aspx.cs" Inherits="reissue" %>
...
<div class="panel-title"> REISSUE RFID </div>
</div>
...
<div class="form-group">
<label for="NEW RFID" class="col-md-3 control-label"> NEW RFID NO.</label>
<div class="col-md-6">
<asp:TextBox runat="server" ID="TextBox2" CssClass="form-control" placeholder="NEW RFID no. "></asp:TextBox>
